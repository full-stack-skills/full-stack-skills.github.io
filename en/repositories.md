...
| Repository | Primary language | Status | Skills | Purpose |
|---|---|---|---:|---|
...
| [testing-skills](https://github.com/full-stack-skills/testing-skills) | Python | Public | 10 | Testing skills - Jest, Vitest, PyTest, JUnit, Cypress, Playwright, Selenium |
| [openspec-skills](https://github.com/full-stack-skills/openspec-skills) | — | Public | 15 | OpenSpec skills - SDD workflow for AI coding agents |
| [stitch-skills](https://github.com/full-stack-skills/stitch-skills) | Python | Public | 29 | Stitch MCP skills - UI design, screen generation, components |
| [agent-skills](https://github.com/full-stack-skills/agent-skills) | Python | Public | 15 | Utility skills - skill creator, SOP creator, skill installer |
| [angular-skills](https://github.com/full-stack-skills/angular-skills) | — | Public | 1 | Angular framework skills for AI coding agents |
...
| [ocrmypdf-skills](https://github.com/full-stack-skills/ocrmypdf-skills) | — | Public | 5 | OCRmyPDF skills - core, image processing, optimization, batch, API |
| [pencil-skills](https://github.com/full-stack-skills/pencil-skills) | Python | Public | 28 | Pencil MCP design skills - design tools, systems, UI design |
| [react-skills](https://github.com/full-stack-skills/react-skills) | TypeScript | Public | 7 | React skills for AI coding agents - React, Hooks, Next.js, Redux, React Native |
| [social-skills](https://github.com/full-stack-skills/social-skills) | Python | Public | 2 | Social skills - Slack GIF creator, internal comms |
...
| [uview-skills](https://github.com/full-stack-skills/uview-skills) | — | Public | 2 | uView UI skills - uView 2.x, uView Pro for uni-app |
...
- **Public**：Anyone can read the repository; this does not automatically mean a stable artifact exists.
- **Private preview**：The project exists but is limited to authorized members; external visitors may receive a 404.
- **Archived**：Kept for history and not a default dependency for new projects.

## Before adopting a repository

1. Read the target repository README and releases.
2. Confirm its license, runtime baseline, and maturity statement.
3. Run the repository’s own gates in your environment; this catalog is not a substitute for verification.
